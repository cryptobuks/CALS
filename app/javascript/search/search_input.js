        ...
        <form onSubmit={(event) => { event.preventDefault(); this.props.searchApiCall(0, this.props.sizeValue) }}>
          <div className='field_input col-xs-12 col-sm-11 col-md-11 col-lg-11'>
            <div className='input_data col-xs-12 col-sm-2 col-md-2 col-lg-2'>
              ...
              <div>
                <select className='searchSelect' id='county_select' value={this.props.countyValue} onChange={(event) => this.props.addValue('countyValue', dictionaryNilSelectValue(event.target.options))}>
                  <option value=' ' />
                  {countyIterate}
                </select>
              </div>
            ...
            <div className='input_data col-xs-12 col-sm-2 col-md-2 col-lg-2'>
              ...
              <div>
                <select className='searchSelect' id='facility_select' value={this.props.facilityTypeValue} onChange={(event) => this.props.addValue('facilityTypeValue', dictionaryNilSelectValue(event.target.options))}>
                  <option value='' />
                  {facilityIterate}
                </select>
              </div>
            ...
            <InputDataBlock
              ...
              <InputComponent id='facilityIdValue'
                ...
                type='text'
                onChange={(event) => this.props.addValue('facilityIdValue', event.target.value)}/>
            </InputDataBlock>
            <InputDataBlock
              title='Facility Name'
              columnWidth={3}>
              <InputComponent id='facilityNameValue'
                ...
                type='text'
                onChange={(event) => this.props.addValue('facilityNameValue', event.target.value)} />
            </InputDataBlock>
            <InputDataBlock
              ...
              <InputComponent id='facilityAddressValue'
                ...
                type='text'
                onChange={(event) => this.props.addValue('facilityAddressValue', event.target.value)} />
            </InputDataBlock>
          </div>
